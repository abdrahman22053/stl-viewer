...
- Transitions fluides avec support système (prefers-color-scheme)
- Design adapté à chaque mode pour un confort optimal

### 🎨 Design & UX
- **Design moderne** avec vibes "coding & tech event"
- Palette de couleurs cyan électrique et orange corail
- Typographie distinctive : Orbitron (titres) + Inter (corps)
- Animations subtiles avec Framer Motion
- Interface 100% responsive (mobile, tablette, desktop)
- Effets de glow et gradients élégants

### 📱 Responsive & Accessible
- Layout adaptatif avec grille CSS moderne
...
- **TanStack Query** - Gestion d'état et cache serveur
